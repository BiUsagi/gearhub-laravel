...
function resetForm() {
    if (
        ...
        removeImage();
        document.getElementById("categoryIcon").value = "bi-tags";
        document.getElementById("selectedIcon").className = "bi bi-tags";
        document.getElementById("previewIcon").className = "bi bi-tags";
        updatePreview();
    }
}
...
function handleFormSubmit(event) {
    ...
    submitBtn.innerHTML =
        '<i class="bi bi-hourglass-split me-2"></i>Đang tạo...';
